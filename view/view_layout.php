	...
	<div class="footer-middle">
				<div class="container">
					<div class="col-md-3 footer-middle-in">
						...
						<p>Hiện nay, thương hiệu thời trang Shopin phát triển ngày càng lớn mạnh. Ngoài ra, nhằm tạo sự tiện lợi mua sắm tối đa cho khách hàng, Shopin phát triển hệ thống bán hàng online, giao hàng đến tận tay người tiêu dùng.</p>
					</div>
			...
			<div class="footer-bottom">
				<div class="container">
					...
					<p class="footer-class">&copy; 2016 Shopin | Design by  <a href="http://w3layouts.com/" target="_blank">Dũng Nguyễn</a> </p>
					<div class="clearfix"> </div>
				</div>
			</div>
		</div>
